...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar hidden">
        <div class="position-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" onclick="mostrarConteudo('document-list')"><i class="bi bi-grid-3x3-gap-fill">
                  Home</i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" onclick="mostrarConteudo('add-document-form')"><i
                  class="bi bi-file-earmark-plus-fill"> Adicionar</i></a>
            </li>
            <li class="nav-item">
          ...
          <form action="" method="POST" enctype="multipart/form-data" class="bg-white p-3 rounded shadow-md">
            ...
            <div>
              ...
              <select name="tipotrabalho" id="document-type" class="w-full border border-gray-300 rounded px-4 py-2"
                value="<?= escape(Input::get('tipotrabalho')) ?>">
            ...
            <div class="mb-4">
              ...
              <textarea id="document-content" name="resumotrabalho"
                class="w-full border border-gray-300 rounded px-4 py-2" rows="4"
                value="<?= escape(Input::get('resumotrabalho')) ?>"></textarea>
            </div>
            <div class="mb-4">
